...
//    NSDictionary *paramDic = @{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"user_id":@(1000089),@"doctor_id":dict[@"doctor_id"]};
...
-(void)getDoctorReceivingSettingWithDict:(NSDictionary *)dict andSuccess:(void(^)(FHDoctorRecModel *DocInfoModel))success andFailure:(void(^)(NSError * error))Failure {
        ...
        //参数
        NSDictionary *paramDic = @{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"doctor_id":dict[@"doctor_id"]};
...
//    NSDictionary *paramDic = @{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"ci1_id":@(1),@"ci2_id":@(3),@"ci3_id":@(3),@"diagnosis_type":@(0),@"is_confirmed":@(1),@"user_id":@(1000089),@"complications":@[@"1",@"",@"",@"",@"",@""],@"has_diagnosis":@(2),@"page":@(3)};
    [self POST:url parameters:dict success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
...
//    NSDictionary *paramDic = @{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"doctor_id":@(300000336)};
    [self POST:url parameters:dict success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
//        NSLog(@"%@",responseObject);
        //字典转模型,模型嵌套;
...
//    NSDictionary *paramDic = @{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"user_id":@(1000089),@"doctor_id":@(300000315)};
...
//    NSDictionary *paramDic = @{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"user_id":@(1000089),@"page_size":@(15),@"page":@(1)};
    [self POST:url parameters:dict success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
        //获取数据
//        NSLog(@"%@",responseObject);
