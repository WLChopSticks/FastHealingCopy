...
- (void)viewDidLoad {
    ...
    /*@{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"ci1_id":@(1),@"ci2_id":@(3),@"ci3_id":@(3),@"diagnosis_type":@(0),@"is_confirmed":@(1),@"user_id":@(1000089),@"complications":@[@"",@"",@"",@"",@"",@""],@"has_diagnosis":@(2)};
     */
...
//        NSLog(@"%ld",self.is_confirmed);
    ...
    decideView.blockClicked = ^() {
       ...
       /* NSDictionary *parameter = @{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"ci1_id":@(self.ci1_id),@"ci2_id":@(self.ci2_id),@"ci3_id":@(self.ci3_id),@"diagnosis_type":@(self.diagnosis_type),@"is_confirmed":@(self.is_confirmed),@"user_id":@1000089, @"complications":@[@"",@"",@"",@"",@"",@""],@"has_diagnosis":@(self.has_diagnosis)}; */
