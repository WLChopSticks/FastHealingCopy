...
- (void)getDocRequestData{
   ...
   // NSLog(@"111111111%@",self.collectionModel.doctor_id);
    NSDictionary *paramDic = @{@"login_token":@"985c96ce43bb5ef69de3e1ad8afaa83f",@"doctor_id":num};
...
- (void)addDoctor {
    ...
    //header 赋值
    //   [sessionManager.requestSerializer setValue:@"985c96ce43bb5ef69de3e1ad8afaa83f" forHTTPHeaderField:@"login_token"];
